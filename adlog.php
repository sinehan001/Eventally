...
<head>
    ...
    <meta name="description" content="Login to your Eventally as Admin, create clubs and post new events in your clubs.">
    <style>
...
<?php
            ...
            <br>
            <span style="color: white;"> New Participant? <a style="color: red;" href="Signup.php">SignUp</a></span>
            <br><br>
            <span style="color: white;"> Already a Participant? <a style="color: red;" href="Login.php">Login</a></span>
            <br><br><span style="color: white;"><a style="color: white;" href="index.php">Go to Home</a></span><br><br>
		</form>
	</div>
