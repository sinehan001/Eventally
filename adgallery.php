...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<meta charset="utf-8">
	<title>Add the Event Photos - Eventally</title>
	<style>
         body
         {
...
<br>
  <div class="container container-center">
    <h2 class="head2" style="text-align:center;">Gallery</h2>
    <form action="cg.php" enctype="multipart/form-data" method="POST">
      <center><label for="image" style="font-size: 24px;">Upload Image to Gallery</label></center>
      <input type="file" name="image" id="image" style="padding-top: 10px;" accept="image/png, image/jpeg" onchange="Filevalidation()"><br><br>
